var sectorNo, carpetArea, area, ghasara, comiValue, landValue, applicableRate, floorRise, ghasaraFall, totalVal;
...
function stamp() {
  ...
  // Show results section AND sharableDiv (table container)
  ...
  // Sector wise values (commercial - unchanged rates)
  if (sectorNo == 1) {
      comiValue = 126500;
      landValue = 41700;
  }
